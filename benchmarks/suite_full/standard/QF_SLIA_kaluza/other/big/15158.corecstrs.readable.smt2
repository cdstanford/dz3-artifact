...
(assert (ite T_SELECT_2 (and (= PCTEMP_LHS_2 (+ I0_24 0)) (= T_f (str.++ T0_24 T1_24)) (= I0_24 (str.len T4_24)) (= 0 (str.len T0_24)) (= T1_24 (str.++ T2_24 T3_24)) (= T2_24 (str.++ T4_24 T5_24)) (= T5_24 "src=") (not (str.in_re T4_24 (re.++ (str.to_re "s") (str.to_re "r") (str.to_re "c") (str.to_re "="))))) (and (= PCTEMP_LHS_2 (- 1)) (= T_f (str.++ T0_24 T1_24)) (= 0 (str.len T0_24)) (not (str.in_re T1_24 (re.++ (str.to_re "s") (str.to_re "r") (str.to_re "c") (str.to_re "=")))))))
