...
(assert (= literal_9 "\u{3c}\u{74}\u{72}\u{3e}\u{0d}\u{0a}\u{3c}\u{74}\u{64}\u{20}\u{63}\u{6c}\u{61}\u{73}\u{73}\u{3d}\u{27}\u{74}\u{62}\u{6c}\u{27}\u{3e}"))
...
(assert (= literal_27 "\u{3c}\u{2f}\u{73}\u{70}\u{61}\u{6e}\u{3e}\u{3c}\u{62}\u{72}\u{3e}\u{0d}\u{0a}\u{3c}\u{73}\u{70}\u{61}\u{6e}\u{20}\u{63}\u{6c}\u{61}\u{73}\u{73}\u{3d}\u{27}\u{73}\u{6d}\u{61}\u{6c}\u{6c}\u{32}\u{27}\u{3e}"))
(assert (= x_29 (str.++ x_25 literal_27)))
(assert (= x_30 (str.++ x_29 sigmaStar_28)))
(assert (= literal_31 "\u{3c}\u{2f}\u{73}\u{70}\u{61}\u{6e}\u{3e}\u{0d}\u{0a}\u{3c}\u{2f}\u{74}\u{64}\u{3e}\u{0d}\u{0a}\u{3c}\u{2f}\u{74}\u{72}\u{3e}\u{5c}\u{6e}"))
