...
(assert (= literal_7 "\u{3c}\u{2f}\u{62}\u{3e}\u{3c}\u{2f}\u{74}\u{64}\u{3e}\u{0d}\u{0a}\u{3c}\u{74}\u{64}\u{20}\u{63}\u{6c}\u{61}\u{73}\u{73}\u{3d}\u{27}\u{74}\u{62}\u{6c}\u{32}\u{27}\u{3e}"))
(assert (= x_9 (str.++ x_6 literal_7)))
(assert (= epsilon ""))
(assert (or (= x_10 epsilon) (= x_10 sigmaStar_2) (= x_10 sigmaStar_1)))
(assert (= x_11 (str.++ x_9 x_10)))
(assert (= literal_12 "\u{3c}\u{2f}\u{74}\u{64}\u{3e}\u{0d}\u{0a}\u{3c}\u{2f}\u{74}\u{72}\u{3e}\u{0d}\u{0a}\u{3c}\u{2f}\u{74}\u{61}\u{62}\u{6c}\u{65}\u{3e}\u{5c}\u{6e}"))
