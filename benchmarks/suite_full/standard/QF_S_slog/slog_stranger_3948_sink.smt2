...
(assert (= literal_15 "\u{3c}\u{62}\u{72}\u{3e}\u{0d}\u{0a}"))
...
(assert (= literal_21 "\u{3c}\u{62}\u{72}\u{3e}\u{3c}\u{62}\u{72}\u{3e}\u{0d}\u{0a}\u{3c}\u{61}\u{20}\u{68}\u{72}\u{65}\u{66}\u{3d}\u{27}\u{64}\u{6f}\u{77}\u{6e}\u{6c}\u{6f}\u{61}\u{64}\u{5f}\u{63}\u{61}\u{74}\u{73}\u{2e}\u{70}\u{68}\u{70}"))
