...
(assert (= literal_2 "\u{3c}\u{2f}\u{73}\u{65}\u{6c}\u{65}\u{63}\u{74}\u{3e}\u{0d}\u{0a}\u{3c}\u{69}\u{6e}\u{70}\u{75}\u{74}\u{20}\u{74}\u{79}\u{70}\u{65}\u{3d}\u{27}\u{73}\u{75}\u{62}\u{6d}\u{69}\u{74}\u{27}\u{20}\u{6e}\u{61}\u{6d}\u{65}\u{3d}\u{27}\u{61}\u{64}\u{64}\u{5f}\u{61}\u{64}\u{6d}\u{69}\u{6e}\u{27}\u{20}\u{76}\u{61}\u{6c}\u{75}\u{65}\u{3d}\u{27}"))
